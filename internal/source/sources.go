...
// or -1 if not found
func IndexByType(slice []v1beta1.Source, sourceType v1beta1.DocsTopicSourceType) int {
...
func FilterByType(sources []v1beta1.Source, sourceType v1beta1.DocsTopicSourceType) []v1beta1.Source {
